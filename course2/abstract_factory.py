...
class EasyLevel(AbstractLevel):
    class Map(EasyMap):
        def create_map(self):
            return EasyMap.get_map(self)

    class Objects(EasyObjects):
        def create_objects(self):
            return EasyObjects.get_objects(self)


class MediumLevel(AbstractLevel):
    class Map(MediumMap):
        def create_map(self):
            return MediumMap.get_map(self)

    class Objects(MediumObjects):
        def create_objects(self):
            return MediumObjects.get_objects(self)


class HardLevel(AbstractLevel):
    class Map(HardMap):
        def create_map(self):
            return HardMap.get_map(self)

    class Objects(HardObjects):
        def create_objects(self):
            return HardObjects.get_objects(self)
